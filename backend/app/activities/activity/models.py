...
class Activity(Base):
    ...
    def to_dict(self):
        return {
            ...
            "total_elapsed_time": float(self.total_elapsed_time),
            "total_timer_time": float(self.total_timer_time),
            "city": self.city,
            "town": self.town,
            ...
            "max_speed": float(self.max_speed) if self.max_speed is not None else None,
            "average_power": self.average_power,
            "max_power": self.max_power,
            "normalized_power": self.normalized_power,
            "average_hr": self.average_hr,
            "max_hr": self.max_hr,
            "average_cad": self.average_cad,
            "max_cad": self.max_cad,
            "workout_feeling": self.workout_feeling,
            "workout_rpe": self.workout_rpe,
            "calories": self.calories,
            "visibility": self.visibility,
            "gear_id": self.gear_id,
            "strava_gear_id": self.strava_gear_id,
            "strava_activity_id": self.strava_activity_id,
            "garminconnect_activity_id": self.garminconnect_activity_id,
            "garminconnect_gear_id": self.garminconnect_gear_id,
            "import_info": self.import_info,
            "is_hidden": self.is_hidden,
            "tracker_manufacturer": self.tracker_manufacturer,
