...
def upgrade() -> None:
    ...
    op.drop_column('users_integrations', 'strava_subscription_id')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('users_integrations', sa.Column('strava_subscription_id', sa.INTEGER(), autoincrement=False, nullable=True, comment='Strava subscription ID for webhook events'))
